  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 bg-black min-h-screen text-slate-300">
      ...
      <div className="mt-8 space-y-5 text-[12px] md:text-[13px] leading-relaxed">
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">1. ABOUT LIVETIMEDATA</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">3. ELIGIBILITY AND MINORS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">4. ACCEPTABLE USE</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">5. SUBMISSIONS AND CONTRIBUTIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">6. EDITING, AI PROCESSING, AND DERIVATIVE WORKS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">7. ATTRIBUTION AND COMPENSATION</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">8. YOUR AUTHORITY TO SUBMIT MATERIAL</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">9. PHOTOGRAPHS, IMAGES, VIDEO, AND OTHER MEDIA</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">10. EVENT SUBMISSIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">11. WEBCAM SUBMISSIONS AND SUGGESTIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">12. STORIES, FACTS, HISTORY, AND LOCAL INFORMATION</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">13. MODERATION AND PROHIBITED SUBMISSIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">14. SUBMISSION REMOVAL REQUESTS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">15. COPYRIGHT AND INTELLECTUAL PROPERTY</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">16. COPYRIGHT INFRINGEMENT COMPLAINTS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">17. RESPONSE TO COPYRIGHT COMPLAINTS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">18. COUNTER-NOTIFICATIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">19. REPEAT INFRINGEMENT</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">20. OTHER CONTENT, PHOTO, WEBCAM, PRIVACY, AND RIGHTS COMPLAINTS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">21. THIRD-PARTY CONTENT, LINKS, DATA, AND EMBEDS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">22. INFORMATION ACCURACY</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">23. ADVERTISING, SPONSORSHIPS, AND AFFILIATE RELATIONSHIPS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">24. CONTESTS, PROMOTIONS, AND SPECIAL PROGRAMS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">25. COMMUNICATIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">26. SERVICE CHANGES AND AVAILABILITY</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">27. DISCLAIMER OF WARRANTIES</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">28. LIMITATION OF LIABILITY</h3>
        ...
        <ul className="list-disc pl-6 space-y-1.5 uppercase">
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">29. INDEMNIFICATION</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">30. PRIVACY</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">31. MOBILE DEVICES AND FUTURE APPLICATIONS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">32. GOVERNING LAW</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">33. SEVERABILITY AND NO WAIVER</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">34. CHANGES TO THESE TERMS</h3>
        ...
        <h3 className="text-[14px] md:text-[15px] font-bold text-white uppercase tracking-wider mt-10 mb-2">35. CONTACT</h3>
